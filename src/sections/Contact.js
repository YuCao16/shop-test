            ...
            icon: (props) => (
                <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
                    <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022
                        5.92a8.19 8.19 0 01 - 2.357.646 4.118 4.118 0 001.804 -
                            2.27 8.224 8.224 0 01 - 2.605.996 4.107 4.107 0
                        00 - 6.993 3.743 11.65 11.65 0 01 - 8.457 -
                            4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8
                        9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01 -
                            1.853.07 4.108 4.108 0 003.834 2.85A8.233
                ...
                <div className="flex flex-col space-y-2 uppercase text-lg font-normal w-fit">
                    <p>
                        ...
                        <a href="/" className=" ml -
                            ...
                            <div className =
                                 "w-full md:hidden flex flex-col items-center justify-between mt-10"><
                        Image
                    url = {logoImage} additionalClasses =
                        {['h-10 md:h-16 w-auto mb-20']} alt = "Logo"
                    width = "150"
                    height="39"
                />
        ...
        <div className="flex flex-wrap justify-center md:justify-start order-1 md:order-2">
            <div className="basis-10/12 lg:basis-2/3 xl:basis-1/2 order-1 md:order-2">
                ...
                / / < form
                        ...
                        //             placeholder:text-base placeholder:italic
                        //             placeholder:uppercase border"
                        //                 placeholder="Name"
                        //             />
                        //         </div>
                        //         <div>
                        ...
                        //         label={buttonLabel}
                        //         rounded="none"
                        //         additionalClasses={['w-fit text-base
                        ...
                        <form accept - charset = "UTF-8" action =
                             "https://getform.io/f/{unique-endpoint-generated-on-step-1}" method =
                                 "POST"><input type = "email" name =
